...
| Path | Purpose |
|:-----|:--------|
| `.mindspec/core/` | Permanent architectural and convention documents |
| `.mindspec/domains/<domain>/` | Domain-scoped documentation (overview, architecture, interfaces, runbook, ADRs) |
| `.mindspec/specs/` | Historical and active specifications |
| `.mindspec/context-map.md` | Bounded context relationships and integration contracts |
| `.mindspec/adr/` | Cross-cutting architecture decision records |
...
Each domain lives at `/.mindspec/domains/<domain>/` with:
...
- Cross-cutting: `.mindspec/adr/ADR-NNNN.md`
- Domain-scoped: `.mindspec/domains/<domain>/adr/ADR-NNNN.md`
