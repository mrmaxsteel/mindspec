...
2. Creates `.mindspec/specs/009-feature-name/spec.md` from template
...
3. Creates `.mindspec/specs/<id>/plan.md` with YAML frontmatter (`status: Draft`)
...
### Agent does
1. Reads the spec's acceptance criteria from `.mindspec/specs/<id>/spec.md`
