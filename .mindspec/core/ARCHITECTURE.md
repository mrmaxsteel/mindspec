...
| Long-form specifications | `/.mindspec/specs/` |
| Domain architecture and documentation | `/.mindspec/domains/<domain>/` |
| ADR lifecycle | `/.mindspec/adr/` and `/.mindspec/domains/<domain>/adr/` |
...
**Domain doc structure** (`/.mindspec/domains/<domain>/`):
...
Location: `/.mindspec/context-map.md`
