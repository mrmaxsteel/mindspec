...
2. Update `.mindspec/domains/execution/overview.md` with the refined conceptual model
3. Update `.mindspec/domains/execution/architecture.md` to reference `MindspecExecutor`
4. Update `.mindspec/domains/workflow/` docs to describe the workflow layer's responsibility for plan quality
...
- `.mindspec/domains/execution/` — all three docs
- `.mindspec/domains/workflow/` — architecture and overview updates
