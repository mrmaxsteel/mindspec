...
- **ADR-0029** (new — "Supply Chain Attestations via Cosign Keyless +
  ...
  `.mindspec/adr/ADR-0029-supply-chain-attestations.md` already
...
2. Finalize `.mindspec/adr/ADR-0029-supply-chain-attestations.md`
...
4. Verify no other ADR (ADR-0025, ADR-0027, ADR-0028) contains stale
   ...
   `grep -l '0029' .mindspec/adr/` returns at minimum the new
...
- [ ] `.mindspec/adr/ADR-0029-supply-chain-attestations.md`
...
- [ ] ADR-0029 inlines the planned signs:/sboms: stanza shapes from
      ...
      `grep -q 'artifacts: archive' .mindspec/adr/ADR-0029-supply-chain-attestations.md`
      AND
      `grep -q 'artifacts: checksum' .mindspec/adr/ADR-0029-supply-chain-attestations.md`
      both succeed.
...
- [ ] Spec AC "An ADR named `ADR-<NNNN>-supply-chain-attestations.md`
      exists under `.mindspec/adr/` … and records the
