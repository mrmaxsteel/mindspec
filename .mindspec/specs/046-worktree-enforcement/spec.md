...
25. A new `.mindspec/core/GIT-WORKFLOW.md` document that covers:
...
- `.mindspec/core/GIT-WORKFLOW.md` — new doc: branching model, worktree lifecycle, enforcement, troubleshooting
- `.mindspec/core/USAGE.md` — update to reference GIT-WORKFLOW.md
...
- [ ] `.mindspec/core/GIT-WORKFLOW.md` exists and covers branching model, worktree lifecycle, enforcement layers, merge strategies, and troubleshooting
