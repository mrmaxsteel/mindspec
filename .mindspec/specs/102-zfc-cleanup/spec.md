...
- workflow: owns `internal/hook/**` and the ADR docs (`.mindspec/adr/**`).
...
- `.mindspec/adr/ADR-0037-panel-gate-enforced-contract.md` — dated
...
- [ ] R1: ADR-0037 carries a dated amendment note recording the retirement; `grep -n "retire" .mindspec/adr/ADR-0037-panel-gate-enforced-contract.md` shows the new note dated 2026-06.
