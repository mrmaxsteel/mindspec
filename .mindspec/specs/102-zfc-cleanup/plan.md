...
7. `.mindspec/adr/ADR-0037-panel-gate-enforced-contract.md` — add a dated
...
- `.mindspec/adr/ADR-0037-panel-gate-enforced-contract.md` — dated 2026-06-17
...
- [ ] ADR-0037 carries the dated retirement amendment: `grep -n "retire" .mindspec/adr/ADR-0037-panel-gate-enforced-contract.md` shows the new note dated 2026-06 (spec L258).
