...
- `project-docs/user/templates/spec.md` — add canonical approval frontmatter fields
- `.mindspec/core/USAGE.md` — clarify Phase 9 close-out contract
- `.mindspec/core/MODES.md` — clarify `complete` vs `approve impl` distinction
...
- [ ] `project-docs/user/templates/spec.md` documents canonical approval fields in YAML frontmatter
