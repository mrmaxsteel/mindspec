...
**Steps**
1. Create `project-docs/research/scaling-agent-systems.md` with full citation of Kim et al. (2025), key findings (sequential degradation, optimal redundancy R≈0.41, 3-4 agent sweet spot, capability saturation, tool fragmentation penalty), metric definitions, and threshold rationale
...
3. Add a reference line in the instruct template pointing agents to `project-docs/research/scaling-agent-systems.md` for full context

**Verification**
- [ ] `project-docs/research/scaling-agent-systems.md` exists with citation, key findings, metrics, thresholds
