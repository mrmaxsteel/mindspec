...
6. Canonical docs include `.mindspec/specs/`, `.mindspec/adr/`, `.mindspec/domains/`, `.mindspec/core/`, `.mindspec/context-map.md`, and `.mindspec/docs/glossary.md`.
...
31. Architecture artifact reconciliation must be explicit:
   - `docs/core/ARCHITECTURE.md` migrates to `.mindspec/core/ARCHITECTURE.md`
   - `docs/adr/*.md` migrates to `.mindspec/adr/*.md`
...
- Architecture artifact mapping is explicit:
  - `docs/core/ARCHITECTURE.md` -> `.mindspec/core/ARCHITECTURE.md`
  - `docs/adr/*.md` -> `.mindspec/adr/*.md`
...
- `test -f .mindspec/core/ARCHITECTURE.md && test -d .mindspec/docs/adr && test -f .mindspec/policies.yml`: architecture artifact mapping is correct post-migration.
