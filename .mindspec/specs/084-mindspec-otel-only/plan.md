...
5. Draft `.mindspec/adr/ADR-0028-bench-removed-from-mindspec.md`
...
3. Measure the post-delete `go build ./cmd/mindspec` binary size on
   ...
   baseline.
4. Author `.mindspec/adr/ADR-0027-mindspec-otel-config-only.md`
...
5. Append a prose postscript to `.mindspec/adr/ADR-0011.md`
...
6. Edit `.mindspec/specs/084-mindspec-otel-only/spec.md` ADR
