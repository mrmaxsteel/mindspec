...
- `./bin/mindspec spec-init 999-test && cat .mindspec/specs/999-test/lifecycle.yaml`: Shows `phase: spec`, no molecule_id
- `grep -r molecule_id .mindspec/specs/999-test/`: No matches
