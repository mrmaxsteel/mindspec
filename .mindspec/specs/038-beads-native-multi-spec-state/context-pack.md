...
- **Spec**: 038-beads-native-multi-spec-state
- **Mode**: plan
- **Commit**: 9c8acc71dbc67ede2fa60c5c7d5ce1fe8193880a
- **Generated**: 2026-02-19T15:43:59Z
...
|:---|:---------|:------------|:----------|
| plan-mode-no-code | error | In Plan Mode, only Beads entries, plan documents, ADR proposals, and documentation may be modified. Code changes are forbidden until the plan is approved. | .mindspec/core/MODES.md#plan-mode |
...
| adr-divergence-gate | error | If implementation or planning detects that an accepted ADR blocks progress or is unfit, the agent must stop, inform the user, and present divergence options. A new superseding ADR requires human approval. | .mindspec/core/MODES.md#implementation-mode |
| plan-must-cite-adrs | warning | Plans and implementation beads must cite the ADRs they rely on. Uncited ADR reliance is a policy violation. | .mindspec/core/ARCHITECTURE.md#adr-lifecycle |
| domain-operations-require-approval | error | Adding, splitting, or merging domains requires explicit human approval and must produce an ADR. | .mindspec/core/ARCHITECTURE.md#domains |
| spec-declares-impacted-domains | warning | Every spec must declare its impacted domains and relevant ADR touchpoints. | .mindspec/core/MODES.md#spec-mode |
| beads-concise-entries | warning | Beads entries must remain concise and execution-oriented. Long-form specs, ADRs, and domain docs live in the documentation system, not in Beads. | .mindspec/adr/ADR-0002.md |
| beads-active-workset | warning | Keep only active and near-term issues open in Beads. Regularly clean up completed work. Rely on git history + docs for archival traceability. | .mindspec/adr/ADR-0002.md |
| clean-tree-before-transition | error | Working tree must be clean (no uncommitted changes) before starting new work, picking up a bead, or switching modes. If dirty: commit or revert. Never auto-stash. | .mindspec/core/CONVENTIONS.md#clean-tree-rule |
| milestone-commit-at-transition | error | Mode transitions must produce a milestone commit: spec(<bead-id>) for Spec→Plan, plan(<bead-id>) for Plan→Implement, impl(<bead-id>) for Implement→Done. .beads/ changes must be co-committed. | .mindspec/core/CONVENTIONS.md#milestone-commits |
...
|:-------|:--------|:-------|
| .mindspec/domains/workflow/overview.md | Overview | Impacted domain overview |
| .mindspec/domains/workflow/architecture.md | Architecture | Impacted domain architecture (plan/implement tier) |
| .mindspec/domains/context-system/interfaces.md | Neighbor Interfaces | 1-hop neighbor via Context Map |
| .mindspec/domains/core/interfaces.md | Neighbor Interfaces | 1-hop neighbor via Context Map |
| .mindspec/adr/ADR-0001.md | ADR-0001 | Accepted ADR for domains: core, context-system, workflow |
| .mindspec/adr/ADR-0002.md | ADR-0002 | Accepted ADR for domains: workflow, tracking, context-system |
| .mindspec/adr/ADR-0003.md | ADR-0003 | Accepted ADR for domains: workflow, agent-interface, context-system |
| .mindspec/adr/ADR-0005.md | ADR-0005 | Accepted ADR for domains: workflow, core |
| .mindspec/adr/ADR-0008.md | ADR-0008 | Accepted ADR for domains: workflow, tracking |
| .mindspec/adr/ADR-0010.md | ADR-0010 | Accepted ADR for domains: viz, workflow, observability |
| .mindspec/adr/ADR-0012.md | ADR-0012 | Accepted ADR for domains: bead, workflow, core |
| .mindspec/adr/ADR-0013.md | ADR-0013 | Accepted ADR for domains: bead, workflow, core |
| .mindspec/adr/ADR-0014.md | ADR-0014 | Accepted ADR for domains: core, context-system, workflow |
