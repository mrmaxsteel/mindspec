...
- `.mindspec/adr/ADR-NNNN.md` — 24 markdown files with convention-based metadata parsing
...
4. A file-based implementation reads from `.mindspec/adr/ADR-NNNN.md` markdown files
...
- [ ] ADR markdown files in `.mindspec/adr/` remain the source of truth
