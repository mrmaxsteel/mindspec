> **ARCHIVED**: This document is superseded by [mindspec-v1-spec.md](mindspec-v1-spec.md), [ADR-0001](../../../.mindspec/adr/ADR-0001.md), and [ADR-0002](../../../.mindspec/adr/ADR-0002.md). Retained for historical context only.
