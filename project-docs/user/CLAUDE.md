...
MindSpec is a spec-driven development framework (Claude Code-first). See [USAGE.md](../../.mindspec/core/USAGE.md) for the development workflow, or [Claude Code quick start](guides/claude-code.md) for the quick start guide.
